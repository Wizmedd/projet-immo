...
final class Version20230616184827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('RENAME TABLE options TO new_options');
        $this->addSql('ALTER TABLE products_options RENAME INDEX IDX_B0800DA3ADB05F1 TO IDX_B0800DA3ADB05F2');
        $this->addSql('ALTER TABLE products_options RENAME CONSTRAINT FK_B0800DA3ADB05F1 TO FK_B0800DA3ADB05F2');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('RENAME TABLE new_options TO options');
        $this->addSql('CREATE TABLE products_options (products_id INT NOT NULL, options_id INT NOT NULL, INDEX IDX_B0800DA3ADB05F2 (options_id), INDEX IDX_B0800DA6C8A81A9 (products_id), PRIMARY KEY(products_id, options_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE products_options ADD CONSTRAINT FK_B0800DA3ADB05F2 FOREIGN KEY (options_id) REFERENCES options (id) ON DELETE CASCADE');
