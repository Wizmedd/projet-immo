L.StreetView = L.Control.extend({
    ...
    providers: [
      ['google', '<i class="fas fa-street-view"></i>', 'Google Street View', false,
    ...
    _addProvider: function(provider) {
      ...
      L.DomEvent.on(button, 'click', function(e) {window.alert("Vous allez être redirigé vers Google Maps Street View")})
